package com.rafaelbarreto.workshopmongo.config;


import com.rafaelbarreto.workshopmongo.domain.Post;
import com.rafaelbarreto.workshopmongo.domain.User;
import com.rafaelbarreto.workshopmongo.dto.AuthorDTO;
import com.rafaelbarreto.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2023"), "Partiu viagem", "Vou viajar para Sao Paulo, abracos", new AuthorDTO(maria));
        Post post2 = new Post(null, sdf.parse("21/03/2023"),"Bom dia","Acordei feliz hoje",new AuthorDTO(maria));
